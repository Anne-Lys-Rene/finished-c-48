...
var backgroundimg;
var start;
var ques1Flag = true, ques2Flag = true, ques3Flag = true, ques4Flag = true, ques5Flag = true, ques6Flag = true, ques7Flag = true, ques8Flag = true, ques9Flag = true, ques10Flag = true;
var bg, bg_img;
var song;
...
function preload(){
    ...
    bg_img = loadImage("scrolling_background.jpg");
